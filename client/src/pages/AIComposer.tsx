    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                <h1 className="text-3xl font-bold text-slate-900 tracking-tight">What should we create today?</h1>
                ...
                <div className="relative mt-12">
                    ...
                    className="w-full px-6 py-6 bg-white border border-slate-300 rounded-xl
                     ...
                     <div className="absolute bottom-4 right-2.5 flex items-center gap-3 text-sm">
                        ...
                        <button
                        onClick={handleGenerate} disabled={loading} className="bg-slate-900
            ...
            {/* AI Generated Posts */}
            <div className="space-y-6 pt-12 border-t border-slate-300">
                    ...
                    overflow-hidden">
                        <div className="flex flex-col h-full space-y-4">
                            ...
                            <div className="flex items-center gap-2 pt-2">
                                ...
                                hover:text-white text-slate-600 text-xs py-2.5 rounded-lg
                                transition-all">
                                    Schedule Post
                                </button>
                                </div>
                ...
                <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {PLATFORMS.map((p) => {
                                ...
                                return (
                                    ...
                                    className={`p-2.5 rounded-xl border text-xs ${active ? "bg-red-500/80 text-white" : "bg-white border-slate-20 text-slate-400 hover:border-slate-300"}`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="relative">
                            ...
                            border-slate-200 rounded-xl text-sm text-slate-500 focus:outline-none
                            transition-all" value={scheduledDate} onChange={(e)=>setScheduledDate(e.
                            target.value)}/>
                        </div>
                        <div className="relative">
                            ...
                            border-slate-200 rounded-xl text-sm text-slate-500 focus:outline-none
                            transition-all" value={scheduledTime} onChange={(e)=>setScheduledTime(e.
                            target.value)}/>
                        </div>
                    </div>
                    </div>
